...
const CATEGORY = ozonCategoryById("delivered");

export default async function OzonDeliveredPage() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-10">
      ...
      <OzonParcelsSubNav active="delivered" counts={counts} />
      <OzonParcelList parcels={parcels} emptyMessage="Aucun colis livré pour l'instant." />
    </main>
  );
}
