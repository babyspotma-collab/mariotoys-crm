...
const CATEGORY = ozonCategoryById("outOfZone");

export default async function OzonOutOfZonePage() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-10">
      ...
      <OzonParcelsSubNav active="outOfZone" counts={counts} />
      <OzonParcelList parcels={parcels} emptyMessage="Aucun colis hors zone pour l'instant." />
    </main>
  );
}
