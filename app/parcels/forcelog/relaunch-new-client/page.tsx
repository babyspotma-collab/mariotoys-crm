...
const CATEGORY = categoryById("relaunchNewClient");

export default async function RelaunchNewClientPage() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-10">
      ...
      <ParcelsSubNav active="relaunchNewClient" counts={counts} />
      <OrderParcelList
        parcels={parcels}
        emptyMessage="Aucun colis à relancer vers un nouveau client pour l'instant."
      />
    </main>
  );
}
