...
export default async function UncategorizedPage() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-10">
      ...
      <ParcelsSubNav active="uncategorized" counts={counts} />
      <p className="text-xs text-muted mb-6">
        Statuts Forcelog ne correspondant à aucune des 7 catégories ci-dessus
        (ex : Relancer, Programmé, Attente confirmation...).
      </p>
