...
const CATEGORY = categoryById("shipped");
...
export default async function ShippedPage() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-10">
      ...
      <ParcelsSubNav active="shipped" counts={counts} />
      <OrderParcelList parcels={parcels} emptyMessage="Aucun colis expédié pour l'instant." />
    </main>
  );
}
